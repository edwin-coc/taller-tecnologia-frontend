...
export default function MyForm() {
  ...
  const handleInputChange = event => setActions(event.target.value)
  ...
  return (
    <>
      <form onSubmit={sendActions}>
        <Typography component='h4' variant='h5' align='center'>Flujo de datos</Typography>
        ...
        <Typography variant='h6' gutterBottom>Secuencia de acciones</Typography>
